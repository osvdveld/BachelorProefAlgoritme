In dit document leg ik uit hoe de code werkt. Bij vragen, opmerkingen of verbeteringen: oscar.vandevelde@ugent.be. U mag natuurlijk ook altijd de code aanpassen en een Pull Request indienen op deze GitHub-pagina ([text](https://github.com/osvdveld/BachelorProefAlgoritme)).
...
Mensen met partners krijgen (toch niet expliciet) geen voorrang (ik heb hierover getwijfeld om het te implenteren in de code maar was niet zeker of dit de juiste keuze was).
